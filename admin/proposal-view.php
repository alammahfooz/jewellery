                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#proposalSent">Sent Proposal</a>
                        </div>
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-content-right-sidebar-wrapper">
                        ...
                        <div class="proposal-action-btn">
                            ...
                            <div class="d-md-none d-lg-flex">
                                <a href="proposal-edit.php" class="action-btn" data-bs-toggle="tooltip" title="Edit Proposal">
                                ...
                                <div class="card stretch stretch-full">
                                    <div class="card-body task-header d-lg-flex align-items-center justify-content-between">
                                        <div class="mb-4 mb-lg-0">
                                            <h4 class="mb-3 fw-bold text-truncate-1-line">Ecommerce || CRM Applications & Admin Dashboar</h4>
