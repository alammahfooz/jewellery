...
if (isset($_GET['act']) && $_GET['act'] == 'del' && isset($_GET['id'])) {
    ...
    $del_query = "DELETE FROM `order_items` WHERE `id` = $id";
...
if (isset($_GET['act']) && $_GET['act'] == 'cstatus' && isset($_GET['id']) && isset($_GET['status'])) {
    ...
    $update_order = "UPDATE `order_items` 
                     SET `status` = '$status' 
                     WHERE `id` = $id";
    ...
    <a href="order_detail.php?id=<?= $row['order_id']; ?>">
        <?= $row['order_id']; ?>
                                                       ...
                                                       <td>
                                                                ...
                                                                <a class="btn btn-danger" href="order_items.php?act=cstatus&status=1&order_id=<?php echo $row['order_id']; ?>" style="width: 20px; height: 20px;">
