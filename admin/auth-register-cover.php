        ...
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <h4 class="fs-13 fw-bold mb-2">Manage all your Ecommerce crm</h4>
                    ...
                    <form action="index.html" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mt-4">
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label c-pointer text-muted" for="receiveMial" style="font-weight: 400 !important">Yes, I wnat to receive Ecommerce community emails</label>
                            </div>
