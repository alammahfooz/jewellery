  <?php
    ...
    $id = $_GET['id'];
    $row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM home_banner WHERE id='$id'"));
    //    print_r($row);
    //    exit;
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE home_banner SET  banner_title='$banner_title', banner_slug='$banner_slug',
                banner_sub_title ='$banner_sub_title', banner_btn ='$banner_btn', sort_order='$sort_order', status='$status', banner_image='$image',
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-12 mb-4">
                                          <input type="text" name="banner_title" onkeyup="addSlug()" id="banner_title" value="<?php echo $row['banner_title']; ?>" class="form-control mb-2" placeholder="Banner Title" required>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-12 mb-4">
                                          <input type="text" name="banner_slug" id="banner_slug" value="<?php echo $row['banner_slug']; ?>" class="form-control" placeholder="Banner Slug" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-12 mb-4">
                                          <input type="text" name="banner_btn" value="<?php echo $row['banner_btn']; ?>" class="form-control" placeholder="Banner Button" required>
                                      </div>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-12 mb-4">
                                          <textarea type="text" name="banner_sub_title" class="form-control mb-2" placeholder="Banner Sub Title" required><?php echo $row['banner_sub_title']; ?></textarea>
                                      </div>
                                  </div>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-12 mb-4 ">
                                          ...
                                          <img src="<?php echo HTTP_SERVER . 'upload/' . $row['banner_image']; ?>" width="120">
