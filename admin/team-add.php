...
include('layout/header.php');
   ...
   if (isset($_POST['submit'])) {
        ...
        $add_date = time();
        $sql_query = "INSERT INTO `team` (`id`, `title`, `slug`, `sub_title`, `short_description`,`team_btn`, `content`, `team_image`,`sort_order`, `status`, `add_date`) VALUES ('{$id}', '{$title}',  '{$slug}', '{$sub_title}', '{$short_description}', '{$team_btn}', '{$content}', '{$image}', '{$sort_order}',  '{$status}' , '{$add_date}')";
        // print_r($sql_query);
        // exit;
                         ...
                         <form method="post" action="" class="mb-5" enctype="multipart/form-data">
                            <div class="card-body">
                                 ...
                                 <div class="row">
                                   ...
                                   <div class="row">
                                     <div class="col-lg-12 mb-4">
                                         <input type="text" name="sub_title" value="" class="form-control" placeholder="Sub Title" required>
                                     </div>
                                    </div>
                                 ...
                                 <div class="row">
                                     <div class="col-lg-12 mb-4">
                                         <input type="text" name="team_btn" value="" class="form-control" placeholder="Button Url" >
                                     </div>
                                 </div>
                                 ...
                                 <div class="row">
                                     <div class="col-lg-12 mb-4 d-flex ">
                                         <label for="" class="fs-6">Upload Team Image</label>
                                         <input type="file" name="team_image" value="" class="form-control mb-2"></textarea>
                                     </div>
                                 </div>
