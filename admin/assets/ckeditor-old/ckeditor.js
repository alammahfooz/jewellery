...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "P159", version: "4.25.1-lts", revision: "c7e59ec199", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
        ...
        var a = {}; CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var b = CKEDITOR.event.prototype, c; for (c in b) null == a[c] && (a[c] = b[c]) }, CKEDITOR.event.prototype = function () {
            function d(a) { var e = b(this); return e[a] || (e[a] = new c(a)) } var b = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, c = function (a) { this.name = a; this.listeners = [] }; c.prototype = {
                ...
                define: function (a, b) { var c = d.call(this, a); CKEDITOR.tools.extend(c, b, !0) }, on: function (b, c, k, h, l) {
                    function q(x, C, y, l) { x = { name: b, sender: this, editor: x, data: C, listenerData: h, stop: y, cancel: l, removeListener: g }; return !1 === c.call(k, x) ? a : x.data } function g() { x.removeListener(b, c) } var x = this, C = d.call(this, b); if (0 > C.getListenerIndex(c)) {
                        C = C.listeners; k || (k = this); isNaN(l) && (l = 10); q.fn = c; q.priority = l; for (var y = C.length - 1; 0 <= y; y--)if (C[y].priority <= l) return C.splice(y + 1, 0, q), { removeListener: g };
                        C.unshift(q)
                    ...
                    var c = 0, e = function () { c = 1 }, d = 0, h = function () { d = 1 }; return function (l, q, g) {
                        var x = b(this)[l]; l = c; var C = d; c = d = 0; if (x) {
                            var y = x.listeners; if (y.length) for (var y = y.slice(0),
                                F, r = 0; r < y.length; r++) { if (x.errorProof) try { F = y[r].call(this, g, q, e, h) } catch (m) { } else F = y[r].call(this, g, q, e, h); F === a ? d = 1 : "undefined" != typeof F && (q = F); if (c || d) break }
                        } q = d ? !1 : "undefined" == typeof q ? !0 : q; c = l; d = C; return q
                    }
        ...
        function a(a, b, c) { this._minInterval = a; this._context = c; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(b, c || {}); var g = this; this.input = function () { function a() { g._lastOutput = (new Date).getTime(); g._scheduledTimer = 0; g._call() } if (!g._scheduledTimer || !1 !== g._reschedule()) { var x = (new Date).getTime() - g._lastOutput; x < g._minInterval ? g._scheduledTimer = setTimeout(a, g._minInterval - x) : a() } } } function d(x, b, c) {
            ...
            arrayCompare: function (a, b) {
                ...
                var c = b == CKEDITOR.ENTER_BR, g = this.htmlEncode(a.replace(/\r\n/g, "\n")), g = g.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div"; if (!c) {
                    var m = /\n{2}/g; if (m.test(g)) var e = "\x3c" + h + "\x3e", l = "\x3c/" + h + "\x3e", g = e + g.replace(m, function () {
                        return l +
                            e
                    }) + l
            ...
            getMouseButton: function (a) { return (a = a && a.data ? a.data.$ : a) ? CKEDITOR.tools.normalizeMouseButton(a.button) : !1 }, normalizeMouseButton: function (a, b) { if (!CKEDITOR.env.ie || 9 <= CKEDITOR.env.version && !CKEDITOR.env.ie6Compat) return a; for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE, 4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], g = 0; g < c.length; g++) { var h = c[g]; if (h[0] === a && b) return h[1]; if (!b && h[1] === a) return h[0] } }, convertHexStringToBytes: function (a) {
                var b = [], c = a.length / 2, g; for (g = 0; g < c; g++)b.push(parseInt(a.substr(2 *
                    g, 2), 16)); return b
            }, convertBytesToBase64: function (a) { var b = "", c = a.length, g; for (g = 0; g < c; g += 3) { var h = a.slice(g, g + 3), m = h.length, e = [], l; if (3 > m) for (l = m; 3 > l; l++)h[l] = 0; e[0] = (h[0] & 252) >> 2; e[1] = (h[0] & 3) << 4 | h[1] >> 4; e[2] = (h[1] & 15) << 2 | (h[2] & 192) >> 6; e[3] = h[2] & 63; for (l = 0; 4 > l; l++)b = l <= m ? b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(e[l]) : b + "\x3d" } return b }, style: {
                parse: {
            ...
            $: function (a) { a = a || {}; this.width = a.width; this.style = a.style; this.color = a.color; this._.normalize() }, _: {
                ...
                fromCssRule: function (a) {
                    ...
                    b = b || {}; var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (c, g) { var h = a["border-" + g] || b[g]; c[g] = h ? CKEDITOR.tools.style.parse.sideShorthand(h) : null; return c }, {}); return CKEDITOR.tools.array.reduce(["top", "right", "bottom", "left"], function (b, g) {
                        var h = {}, e; for (e in c) {
                            var l =
                                a["border-" + g + "-" + e]; h[e] = l ? l : c[e] && c[e][g]
        ...
        function a(a, b) { return -1 < (" " + a + " ").replace(e, " ").indexOf(" " + b + " ") } function d(a) { var b = !0; a.$.id || (a.$.id = "cke_tmp_" + CKEDITOR.tools.getNextNumber(), b = !1); return function () { b || a.removeAttribute("id") } } function b(a, b) { var c = CKEDITOR.tools.escapeCss(a.$.id); return "#" + c + " " + b.split(/,\s*/).join(", #" + c + " ") } function c(a) { for (var b = 0, c = 0, g = k[a].length; c < g; c++)b += parseFloat(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b } var f = document.createElement("_").classList, f = "undefined" !== typeof f &&
            null !== String(f.add).match(/\[Native code\]/gi), e = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    } function r(a, b) { var c = { x: 0, y: 0 }; if (!a.is(M ? "body" : "html")) { var g = a.$.getBoundingClientRect(); c.x = g.left; c.y = g.top } g = a.getWindow(); g.equals(b) || (g = r(CKEDITOR.dom.element.get(g.$.frameElement), b), c.x += g.x, c.y += g.y); return c } function m(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 } !a && (a = this.getWindow()); d = a.getDocument(); var M = "BackCompat" == d.$.compatMode; a instanceof CKEDITOR.dom.window && (a = M ? d.getBody() : d.getDocumentElement());
                    CKEDITOR.env.webkit && (d = this.getEditor(!1)) && (d._.previousScrollTop = null); d = a.getWindow(); e = r(this, d); var w = r(a, d), J = this.$.offsetHeight; g = this.$.offsetWidth; var G = a.$.clientHeight, p = a.$.clientWidth; d = e.x - m(this, "left") - w.x || 0; f = e.y - m(this, "top") - w.y || 0; g = e.x + g + m(this, "right") - (w.x + p) || 0; e = e.y + J + m(this, "bottom") - (w.y + G) || 0; (0 > f || 0 < e) && k(0, !0 === b ? f : !1 === b ? e : 0 > f ? f : e); c && (0 > d || 0 < g) && k(0 > d ? d : g, 0)
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var g, e = c.startContainer; g = c.endContainer; var d = c.startOffset, f = c.endOffset, x, h = this.guard, k = this.type, q = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var l = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), E = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext(); this._.guardLTR = function (a, b) {
                    return (!b || !l.equals(a)) && (!E ||
                        !a.equals(E)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            } if (a && !this._.guardRTL) { var A = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(), u = e.type == CKEDITOR.NODE_ELEMENT ? d ? e.getChild(d - 1) : null : e.getPrevious(); this._.guardRTL = function (a, b) { return (!b || !A.equals(a)) && (!u || !a.equals(u)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) } } var z = a ? this._.guardRTL : this._.guardLTR; x = h ? function (a, b) { return !1 === z(a, b) ? !1 : h(a, b) } : z; this.current ? g = this.current[q](!1, k, x) : (a ? g.type == CKEDITOR.NODE_ELEMENT &&
                (g = 0 < f ? g.getChild(f - 1) : !1 === x(g, !0) ? null : g.getPreviousSourceNode(!0, k, x)) : (g = e, g.type == CKEDITOR.NODE_ELEMENT && ((g = g.getChild(d)) || (g = !1 === x(e, !0) ? null : e.getNextSourceNode(!0, k, x)))), g && !1 === x(g) && (g = null)); for (; g && !this._.end;) { this.current = g; if (!this.evaluator || !1 !== this.evaluator(g)) { if (!b) return g } else if (b && this.evaluator) return !1; g = g[q](!1, k, x) } this.end(); return this.current = null
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, e, d) {
            function f(a, b, c, g) { var Y = c ? a.getPrevious() : a.getNext(); if (g && k) return Y; l || g ? b.append(a.clone(!0, d), c) : (a.remove(), q && b.append(a, c)); return Y } function m() { var a, b, c, g = Math.min(L.length, t.length); for (a = 0; a < g; a++)if (b = L[a], c = t[a], !b.equals(c)) return a; return a - 1 } function h() {
                var b = I - 1, c = z && D && !p.equals(v); b < N - 1 || b < n - 1 || c ? (c ? a.moveToPosition(v,
                    CKEDITOR.POSITION_BEFORE_START) : n == b + 1 && u ? a.moveToPosition(t[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(t[b + 1], CKEDITOR.POSITION_BEFORE_START), e && (b = L[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({ startNode: c }))) : a.collapse(!0)
            } a.optimizeBookmark(); var k = 0 === b, q = 1 == b, l = 2 == b; b = l || q; var p = a.startContainer, v = a.endContainer,
                K = a.startOffset, E = a.endOffset, A, u, z, D, H, S; if (l && v.type == CKEDITOR.NODE_TEXT && (p.equals(v) || p.type === CKEDITOR.NODE_ELEMENT && p.getFirst().equals(v))) c.append(a.document.createText(v.substring(K, E))); else {
                    v.type == CKEDITOR.NODE_TEXT ? l ? S = !0 : v = v.split(E) : 0 < v.getChildCount() ? E >= v.getChildCount() ? (v = v.getChild(E - 1), u = !0) : v = v.getChild(E) : D = u = !0; p.type == CKEDITOR.NODE_TEXT ? l ? H = !0 : p.split(K) : 0 < p.getChildCount() ? 0 === K ? (p = p.getChild(K), A = !0) : p = p.getChild(K - 1) : z = A = !0; for (var L = p.getParents(), t = v.getParents(), I = m(),
                        N = L.length - 1, n = t.length - 1, B = c, Y, aa, W, ea = -1, U = I; U <= N; U++) { aa = L[U]; W = aa.getNext(); for (U != N || aa.equals(t[U]) && N < n ? b && (Y = B.append(aa.clone(0, d))) : A ? f(aa, B, !1, z) : H && B.append(a.document.createText(aa.substring(K))); W;) { if (W.equals(t[U])) { ea = U; break } W = f(W, B) } B = Y } B = c; for (U = I; U <= n; U++)if (c = t[U], W = c.getPrevious(), c.equals(L[U])) b && (B = B.getChild(0)); else { U != n || c.equals(L[U]) && n < N ? b && (Y = B.append(c.clone(0, d))) : u ? f(c, B, !1, D) : S && B.append(a.document.createText(c.substring(0, E))); if (U > ea) for (; W;)W = f(W, B, !0); B = Y } l ||
                            h()
                }
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && q(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var e = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), q = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } function e(a, b, c) {
                    ...
                    case CKEDITOR.ENLARGE_INLINE: var h = 1; case CKEDITOR.ENLARGE_ELEMENT: if (this.collapsed) break; var k = this.getCommonAncestor(); m = this.root; var q, l, p, v, K, E = !1, A; A = this.startContainer; var u = this.startOffset; A.type == CKEDITOR.NODE_TEXT ? (u && (A = !CKEDITOR.tools.trim(A.substring(0, u)).length && A, E = !!A), A && ((v = A.getPrevious()) || (p = A.getParent()))) : (u && (v = A.getChild(u - 1) || A.getLast()), v || (p = A)); for (p = c(p); p ||
                        v;) {
                            if (p && !v) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !m.contains(p)) break; E && "inline" == p.getComputedStyle("display") || (E = !1, K ? q = p : this.setStartBefore(p)); v = p.getPrevious() } for (; v;)if (A = !1, v.type == CKEDITOR.NODE_COMMENT) v = v.getPrevious(); else {
                                if (v.type == CKEDITOR.NODE_TEXT) f = v.getText(), d.test(f) && (v = null), A = /[\s\ufeff]$/.test(f); else if ((v.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && v.is("br")) && !v.data("cke-bookmark")) if (E && CKEDITOR.dtd.$removeEmpty[v.getName()]) {
                                    f = v.getText(); if (d.test(f)) v =
                                        null; else for (var u = v.$.getElementsByTagName("*"), z = 0, D; D = u[z++];)if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) { v = null; break } v && (A = !!f.length)
                                } else v = null; A && (E ? K ? q = p : p && this.setStartBefore(p) : E = !0); if (v) { A = v.getPrevious(); if (!p && !A) { p = v; v = null; break } v = A } else p = null
                            } p && (p = c(p.getParent()))
                    } A = this.endContainer; u = this.endOffset; p = v = null; K = E = !1; A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(u)).length ? E = !0 : (E = !A.getLength(), u == A.getLength() ? (v = A.getNext()) || (p = A.getParent()) : e(A,
                        u, m) && (p = A.getParent())) : (v = A.getChild(u)) || (p = A); for (; p || v;) {
                            if (p && !v) { !K && p.equals(k) && (K = !0); if (h ? p.isBlockBoundary() : !m.contains(p)) break; E && "inline" == p.getComputedStyle("display") || (E = !1, K ? l = p : p && this.setEndAfter(p)); v = p.getNext() } for (; v;) {
                                A = !1; if (v.type == CKEDITOR.NODE_TEXT) f = v.getText(), e(v, 0, m) || (v = null), A = /^[\s\ufeff]/.test(f); else if (v.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < v.$.offsetWidth || b && v.is("br")) && !v.data("cke-bookmark")) if (E && CKEDITOR.dtd.$removeEmpty[v.getName()]) {
                                        f = v.getText(); if (d.test(f)) v =
                                            null; else for (u = v.$.getElementsByTagName("*"), z = 0; D = u[z++];)if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) { v = null; break } v && (A = !!f.length)
                                    } else v = null
                                } else A = 1; A && E && (K ? l = p : this.setEndAfter(p)); if (v) { A = v.getNext(); if (!p && !A) { p = v; v = null; break } v = A } else p = null
                            } p && (p = c(p.getParent()))
                        } q && l && (k = q.contains(l) ? l : q, this.setStartBefore(k), this.setEndAfter(k)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: p = new CKEDITOR.dom.range(this.root); m = this.root; p.setStartAt(m,
                            CKEDITOR.POSITION_AFTER_START); p.setEnd(this.startContainer, this.startOffset); p = new CKEDITOR.dom.walker(p); var H, S, L = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), t = null, I = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (t) { if (t.equals(a)) { t = null; return } } else t = a; else if (t) return; var b = L(a); b || (H = a); return b }, h = function (a) { var b = I(a); !b && a.is && a.is("br") && (S = a); return b }; p.guard = I; p = p.lastBackward(); H = H || m; this.setStartAt(H,
                                !H.is("br") && (!p && this.checkStartOfBlock() || p && H.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { p = this.clone(); p = new CKEDITOR.dom.walker(p); var N = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(); p.evaluator = function (a) { return !N(a) && !n(a) }; if ((p = p.previous()) && p.type == CKEDITOR.NODE_ELEMENT && p.is("br")) break } p = this.clone(); p.collapse(); p.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); p = new CKEDITOR.dom.walker(p); p.guard =
                                    a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? h : I; H = t = S = null; p = p.lastForward(); H = H || m; this.setEndAt(H, !p && this.checkEndOfBlock() || p && H.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); S && this.setEndAfter(S)
                }
                ...
                var e = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, d = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var f = this.clone(), m = this.startContainer, h = this.endContainer, k = this.startOffset, q = this.endOffset,
                        l = c = 1; m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength() ? f.setStartAfter(m) : (f.setStartBefore(m), c = 0) : f.setStartBefore(m)); h && h.type == CKEDITOR.NODE_TEXT && (q ? q >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), l = 0) : f.setEndBefore(h)); var f = new CKEDITOR.dom.walker(f), p = CKEDITOR.dom.walker.bookmark(), v = CKEDITOR.dom.walker.bogus(); f.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var K; f.guard = function (b, c) {
                        ...
                        }; c && (m = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(m, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START); l && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward" : "previous"]()) && this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!c && !l)
                }
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, e, f) {
            ...
            h = function (a) { return e(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, C, y, F; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var M = 0, w = m.hasAscendant("pre"), J = m.type != CKEDITOR.NODE_ELEMENT, G = 0; if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0); else {
                            var p = m.getName();
                            if (CKEDITOR.dtd.$block[p] && "false" == m.getAttribute("contenteditable")) { d = m; b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if ("br" == p) J = 1; else if (!k && !m.getChildCount() && "hr" != p) { d = m; C = m.equals(r); break } k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = m)); M = 1 } else { if (m.getFirst()) { k || (k = this.range.clone(), k.setStartAt(m, CKEDITOR.POSITION_BEFORE_START)); m = m.getFirst(); continue } J = 1 }
                        } J && !k && (k = this.range.clone(), k.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                        C = (!M || J) && m.equals(r); if (k && !M) for (; !m.getNext(h) && !C;) { p = m.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { M = 1; J = 0; C || p.equals(r); k.setEndAt(p, CKEDITOR.POSITION_BEFORE_END); break } m = p; J = 1; C = m.equals(r); G = 1 } J && k.setEndAt(m, CKEDITOR.POSITION_AFTER_END); m = this._getNextSourceNode(m, G, r); if ((C = !m) || M && k) break
                    } if (!d) {
                        ...
                        d = d.block; !d && m && !this.enforceRealBlocks && M[m.getName()] && k.checkStartOfBlock() && k.checkEndOfBlock() && !m.equals(k.root) ? d = m : !d || this.enforceRealBlocks && d.is(l) ? (d = this.range.document.createElement(a), k.extractContents().appendTo(d), d.trim(), k.insertNode(d), y = F = !0) : "li" != d.getName() ? k.checkStartOfBlock() && k.checkEndOfBlock() || (d = d.clone(!1), k.extractContents().appendTo(d), d.trim(), F = k.splitBlock(), y = !F.wasStartOfBlock, F = !F.wasEndOfBlock, k.insertNode(d)) : C || (this._.nextNode = d.equals(r) ? null : this._getNextSourceNode(k.getBoundaryNodes().endNode,
                            1, r))
                    } y && (y = d.getPrevious()) && y.type == CKEDITOR.NODE_ELEMENT && ("br" == y.getName() ? y.remove() : y.getLast() && "br" == y.getLast().$.nodeName.toLowerCase() && y.getLast().remove()); F && (y = d.getLast()) && y.type == CKEDITOR.NODE_ELEMENT && "br" == y.getName() && (!CKEDITOR.env.needsBrFiller || y.getPrevious(e) || y.getNext(e)) && y.remove(); this._.nextNode || (this._.nextNode = C || d.equals(r) || !r ? null : this._getNextSourceNode(d, 1, r)); return d
    ...
    (function () {
        function a(a, b, c, e, d) {
            var f, g; a = []; for (f in b) {
                g = b[f]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : z(g); "$" != f.charAt(0) && (g.elements = f); c && (g.featureName = c.toLowerCase()); var n = g; n.elements = k(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var u = /\s*,\s*/, t = void 0; for (t in S) {
                    n[t] = k(n[t], u) || null; var m = n, D = L[t], h = k(n[L[t]], u), E = n[t], B = [], H = !0, I = void 0; h ? H = !1 : h = {}; for (I in E) "!" == I.charAt(0) && (I = I.slice(1), B.push(I), h[I] = !0, H = !1); for (; I = B.pop();)E[I] = E["!" +
                        I], delete E["!" + I]; m[D] = (H ? !1 : h) || null
                } n.match = n.match || null; e.push(g); a.push(g)
            } b = d.elements; d = d.generic; var A; c = 0; for (e = a.length; c < e; ++c) {
                f = z(a[c]); g = !0 === f.classes || !0 === f.styles || !0 === f.attributes; n = f; t = D = u = void 0; for (u in S) n[u] = M(n[u]); m = !0; for (t in L) { u = L[t]; D = n[u]; h = []; E = void 0; for (E in D) -1 < E.indexOf("*") ? h.push(new RegExp("^" + E.replace(/\*/g, ".*") + "$")) : h.push(E); D = h; D.length && (n[u] = D, m = !1) } n.nothingRequired = m; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === f.elements || null ===
                    f.elements) d[g ? "unshift" : "push"](f); else for (A in n = f.elements, delete f.elements, n) if (b[A]) b[A][g ? "unshift" : "push"](f); else b[A] = [f]
            }
        } function d(a, c, e, d) {
            ...
            b) { if (!a) return !1; var c = !1, e = !0 === a, d; for (d in b) if (e || a(d)) delete b[d], c = !0; return c } function e(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = D(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, e = 0, d; for (d in a) c[d] = a[d], e++; return e ? c : !1 } function h(a, b) {
            ...
            } function g(a) { var b, c, e, d, f = {}, g = 1; for (a = D(a); b = a.match(t);)(c = b[2]) ? (e = x(c, "styles"), d = x(c, "attrs"), c = x(c, "classes")) : e = d = c = null, f["$" + g++] = { elements: b[1], classes: c, styles: e, attributes: d }, a = a.slice(b[0].length); return f } function x(a, b) { var c = a.match(I[b]); return c ? D(c[1]) : null } function C(a) {
                ...
                var g = 0, u; f.toHtml && (b.name = b.name.replace(N, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { u = a.elementCallbacks; for (var t = 0, k = u.length, D; t < k; ++t)if (D = u[t](b)) { u = D; break a } u = void 0 } if (u) return u } if (f.doTransform && (u = a._.transformations[b.name])) { C(b); for (t = 0; t < u.length; ++t)p(a, b, u[t]); r(b) } if (f.doFilter) {
                    a: {
                        t = b.name; k = a._; a = k.allowedRules.elements[t]; u = k.allowedRules.generic; t = k.disallowedRules.elements[t]; k = k.disallowedRules.generic;
                        D = f.skipRequired; var h = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, z, E; if (a || u) { C(b); if (t) for (z = 0, E = t.length; z < E; ++z)if (!1 === c(t[z], b, h)) { a = null; break a } if (k) for (z = 0, E = k.length; z < E; ++z)c(k[z], b, h); if (a) for (z = 0, E = a.length; z < E; ++z)d(a[z], b, h, D); if (u) for (z = 0, E = u.length; z < E; ++z)d(u[z], b, h, D); a = h } else a = null
                    } if (!a || !a.valid) return e.push(b), 1; E = a.validAttributes; var B = a.validStyles;
                    u = a.validClasses; var t = b.attributes, H = b.styles, k = b.classes; D = b.classBackup; var L = b.styleBackup, I, A, l = [], h = [], S = /^data-cke-/; z = !1; delete t.style; delete t["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (I in t) E[I] || (S.test(I) ? I == (A = I.replace(/^data-cke-saved-/, "")) || E[A] || (delete t[I], z = !0) : (delete t[I], z = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (I in H) a.allStyles || B[I] ? l.push(I + ":" + H[I]) : z = !0; l.length && (t.style = l.sort().join("; ")) } else L && (t.style = L); if (!a.allClasses ||
                        a.hadInvalidClass) { for (I = 0; I < k.length; ++I)(a.allClasses || u[k[I]]) && h.push(k[I]); h.length && (t["class"] = h.sort().join(" ")); D && h.length < D.split(/\s+/).length && (z = !0) } else D && (t["class"] = D); z && (g = 1); if (!f.skipFinalValidation && !m(b)) return e.push(b), 1
                ...
                return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                    a.name || u.$block[a.name])
            } function G(a, b, c) {
                var e = a.name; if (u.$empty[e] || !a.children.length) "hr" == e && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (u.$block[e] || "tr" == e) if ("br" == b) a.previous && !J(a.previous) && (b = w(), b.insertBefore(a)), a.next && !J(a.next) && (b = w(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var e = a.children, d; b: { d = u[b]; for (var f = 0, g = e.length, n; f < g; ++f)if (n = e[f], n.type == CKEDITOR.NODE_ELEMENT && !d[n.name]) { d = !1; break b } d = !0 } if (d) a.name = b, a.attributes =
                        {}, c.push({ check: "parent-down", el: a }); else { d = a.parent; for (var f = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == d.name, t, k, g = e.length; 0 < g;)n = e[--g], f && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && u.$inline[n.name]) ? (t || (t = new CKEDITOR.htmlParser.element(b), t.insertAfter(a), c.push({ check: "parent-down", el: t })), t.add(n, 0)) : (t = null, k = u[d.name] || u.span, n.insertAfter(a), d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || k[n.name] || c.push({ check: "el-up", el: n })); a.remove() }
                } else e in
                    { style: 1, script: 1 } ? a.remove() : (a.parent && c.push({ check: "it", el: a.parent }), a.replaceWithChildren())
            } function p(a, b, c) { var e, d; for (e = 0; e < c.length; ++e)if (d = c[e], !(d.check && !a.check(d.check, !1) || d.left && !d.left(b))) { d.right(b, B); break } } function v(a, b) {
                var c = b.getDefinition(), e = c.attributes, d = c.styles, f, g, n, u; if (a.name != c.element) return !1; for (f in e) if ("class" == f) for (c = e[f].split(/\s+/), n = a.classes.join("|"); u = c.pop();) { if (-1 == n.indexOf(u)) return !1 } else if (a.attributes[f] != e[f]) return !1; for (g in d) if (a.styles[g] !=
                    d[g]) return !1; return !0
            } function K(a, b) { var c, e; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? e = a : (c = a[0], e = a[1]); return [{ element: c, left: e, right: function (a, c) { c.transform(a, b) } }] } function E(a) { return function (b) { return v(b, a) } } function A(a) { return function (b, c) { c[a](b) } } var u = CKEDITOR.dtd, z = CKEDITOR.tools.copy, D = CKEDITOR.tools.trim, H = ["", "p", "br", "div"]; CKEDITOR.FILTER_SKIP_TREE = 2; CKEDITOR.filter = function (a, b) {
                ...
                allow: function (b, c, d) {
                    ...
                    if (this.disabled) return !1; var d = this, f = [], g = this.editor && this.editor.config.protectedSource, n, t = !1, k = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (n = y(d, a, f, k), n & 1) t = !0; else if (n & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var e = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var u, D, z; if (g) for (D = 0; D < g.length; ++D)if ((z = e.match(g[D])) && z[0].length == e.length) {
                                    c =
                                    !0; break a
                                } e = CKEDITOR.htmlParser.fragment.fromHtml(e); 1 == e.children.length && (u = e.children[0]).type == CKEDITOR.NODE_ELEMENT && y(d, u, c, k); c = !c.length
                            } c || f.push(a)
                        }
                    }, null, !0); f.length && (t = !0); var D; a = []; e = H[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var z; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? G(c, e, a) : c.remove(); for (; D = a.pop();)if (c = D.el, c.parent) switch (z = u[c.parent.name] || u.span, D.check) {
                        case "it": u.$removeEmpty[c.name] && !c.children.length ? G(c, e, a) : m(c) || G(c, e, a); break; case "el-up": c.parent.type ==
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, e = [], d; for (b = 0; b < a.length && !d; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (d = c); if (d) { for (b = 0; b < a.length; ++b)e.push(K(a[b], d)); this.addTransformations(e) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var e = this._.transformations, d; for (d = 0; d < a.length; ++d) {
                            b = a[d]; var f = void 0, g = void 0, n = void 0, u = void 0, t = void 0, k = void 0; c = []; for (g = 0; g < b.length; ++g)n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), u = n[0], t = null, k = n[1]) : (u = n.check, t = n.left, k = n.right), f || (f = n, f = f.element ? f.element : u ? u.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), t instanceof CKEDITOR.style && (t = E(t)), c.push({ check: u == f ? null : u, left: t, right: "string" == typeof k ? A(k) : k }); b = f; e[b] || (e[b] = []); e[b].push(c)
                        }
                    }
                    ...
                    } else d = a.getDefinition(), n = d.styles, e = d.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = z(n), e.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, d = { name: d.element, attributes: e, classes: e["class"] ? e["class"].split(/\s+/) : [], styles: n, children: [] }; var n = CKEDITOR.tools.clone(d), u = [], t; if (!1 !== b && (t = this._.transformations[d.name])) {
                        for (e =
                            0; e < t.length; ++e)p(this, d, t[e]); r(d)
                    } y(this, n, u, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < u.length ? c = !1 : ((b = d.attributes["class"]) && (d.attributes["class"] = d.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(d.attributes, n.attributes, !0), b && (d.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[f] = c); return c
            ...
            }; var S = { styles: 1, attributes: 1, classes: 1 }, L = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, t = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, N = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, B; B = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), e = c.styles, d = c.attributes, f, g, n, u; a.name = c.element; for (f in d) if ("class" ==
                            f) for (c = a.classes.join("|"), n = d[f].split(/\s+/); u = n.pop();)-1 == c.indexOf(u) && a.classes.push(u); else a.attributes[f] = d[f]; for (g in e) a.styles[g] = e[g]
                    }
                }
            }
    })();
        ...
        var a = {}, d = {}; return {
            load: function (b, c, f, e) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var h = b.length, l = h, q = [], g = [], x = function (a) { c && (k ? c.call(f, a) : c.call(f, q, g)) }; if (0 === l) x(!0); else {
                    var C = function (a, b) { (b ? q : g).push(a); 0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b)) }, y = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, F = function (b) {
                        if (a[b]) C(b, !0); else {
                            var e = d[b] || (d[b] = []); e.push(C); if (!(1 < e.length)) {
                                var f =
                                    new CKEDITOR.dom.element("script"); f.setAttributes({ type: "text/javascript", src: b }); c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () { if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, y(b, !0) } : (f.$.onload = function () { setTimeout(function () { f.$.onload = null; f.$.onerror = null; y(b, !0) }, 0) }, f.$.onerror = function () { f.$.onload = null; f.$.onerror = null; y(b, !1) })); f.appendTo(CKEDITOR.document.getHead())
                            }
                        }
                    }; e && CKEDITOR.document.getDocumentElement().setStyle("cursor",
                        "wait"); for (var r = 0; r < h; r++)F(b[r])
                }
            ...
            var e = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(e, a); var b = [], g; for (g in a) {
                        var h = a[g], C = h && h.requires; if (!d[g]) { if (h.icons) for (var y = h.icons.split(","), F = y.length; F--;)CKEDITOR.skin.addIcon(y[F], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + y[F] + ".png"); h.isSupportedEnvironment = h.isSupportedEnvironment || function () { return !0 }; d[g] = 1 } if (C) for (C.split && (C =
                            C.split(",")), h = 0; h < C.length; h++)e[C[h]] || b.push(C[h])
    ...
    (function () {
        ...
        } function e(a, b, c) { if (b) { var e, d, f = a.commands; for (d in f) e = f[d], (c || e.contextSensitive) && e.refresh(a, b) } } function k(a) { var b = a.config.customConfig; if (!b) return !1; var b = CKEDITOR.getUrl(b), c = r[b] || (r[b] = {}); c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && k(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function () { c.fn = c.fn || CKEDITOR.editorConfig || function () { }; k(a) }); return !0 } function h(a, b) {
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function () { q(a) }) } function q(a) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, e = b(c.plugins), d = b(c.extraPlugins), f = b(c.removePlugins); if (d) var g = new RegExp("(?:^|,)(?:" + d.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), e = e.replace(g, ""), e = e + ("," + d); if (f) var k = new RegExp("(?:^|,)(?:" +
                f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), e = e.replace(k, ""); CKEDITOR.env.air && (e += ",adobeair"); CKEDITOR.plugins.load(e.split(","), function (b) {
                    var e = [], d = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        var h = b[g], l = h.lang, L = null, t = h.requires, I; CKEDITOR.tools.isArray(t) && (t = t.join(",")); if (t && (I = t.match(k))) for (; t = I.pop();)CKEDITOR.error("editor-plugin-required", { plugin: t.replace(",", ""), requiredBy: g }); l && !a.lang[g] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ?
                        ...
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)for (var g = 0; g < e.length; g++) {
                                var t = e[g]; 0 === f && d[g] && t.lang && t.langEntries && (a.lang[t.name] =
                                    t.langEntries[d[g]]); if (t[b[f]]) t[b[f]](a)
            ...
            function c(a) { var b = a.startContainer, e = a.endContainer, d = b.is && b.is("tr"), f = b.is && b.is("td"); a = f && b.equals(e) && a.endOffset === b.getChildCount(); b = f && 1 === b.getChildCount() && "img" === b.getChildren().getItem(0).getName(); return d || a && !b ? !0 : !1 } function e(a) { var b = a.startContainer; return b.is("tr") ? a.cloneContents() : b.clone(!0) } for (var d = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                var A = a[h], u = A.startContainer.getAscendant("tr",
                    !0); c(A) ? (f || (f = u.getAscendant("table").clone(), f.append(u.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), d.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(u) || (g = u, k = u.clone(), f.append(k)), k.append(e(A))) : d.append(A.cloneContents())
            ...
            plugins: {
                ...
                var b = CKEDITOR.filter.instances, c = this; this.fire("beforeDestroy"); !a && C.call(this); this.editable(null); this.filter && delete this.filter; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b), function (a) { a = b[a]; c === a.editor && a.destroy() }); delete this.activeFilter; this.status = "destroyed"; this.fire("destroy"); this.removeAllListeners();
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (e, k, h) {
                function l(a) { var b; if (0 < m.length) for (var c = 0; c < m.length; c++) { var e = m[c], d = e.name, f = CKEDITOR.dtd[d], g = w.name && CKEDITOR.dtd[w.name]; g && !g[d] || a && f && !f[a] && CKEDITOR.dtd[a] ? d == w.name && (x(w, w.parent, 1), c--) : (b || (q(), b = 1), e = e.clone(), e.parent = w, w = e, m.splice(c, 1), c--) } } function q() { for (; M.length;)x(M.shift(), w) } function g(a) {
                ...
                } function x(b, c, e) { c = c || w || r; var d = w; void 0 === b.previous && (C(c, b) && (w = c, F.onTagOpen(h, {}), b.returnPoint = c = w), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (G = !1), "textarea" == b.name && (J = !1)); b.returnPoint ? (w = b.returnPoint, delete b.returnPoint) : w = e ? c : d } function C(a, b) {
                    if ((a == r || "body" == a.name) && h && (!a.name || CKEDITOR.dtd[a.name][h])) {
                ...
                } function y(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var F = new CKEDITOR.htmlParser, r = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, m = [], M = [], w = r, J = "textarea" == r.name, G = "pre" == r.name; F.onTagOpen = function (e, f, g, k) {
                    ...
                    if (a(f)) m.push(f); else {
                        if ("pre" == e) G = !0; else { if ("br" == e && G) { w.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) } if ("br" == e) M.push(f); else {
                            for (; !(k = (g = w.name) ? CKEDITOR.dtd[g] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || w.isUnknown || k[e]);)if (w.isOptionalClose) F.onTagClose(g); else if (e in b && g in b) g = w.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), w), !f.returnPoint && (f.returnPoint = w), w = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !y(e, g)) F.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !y(e, g)) !f.returnPoint && (f.returnPoint = w), w = w.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(w), w.parent) x(w, w.parent, 1); else { f.isOrphan = 1; break } l(e); q(); f.parent = w; f.isEmpty ? x(f) : w = f
                        }
                    }
                }; F.onTagClose = function (a) {
                    for (var b = m.length - 1; 0 <= b; b--)if (a == m[b].name) { m.splice(b, 1); return } for (var c = [], e = [], d = w; d != r && d.name != a;)d._.isBlockLike || e.unshift(d), c.push(d), d = d.returnPoint || d.parent; if (d != r) {
                    ...
                    if (!(w._.hasInlineStarted && !M.length || G || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = w.name, e = b ? CKEDITOR.dtd[b] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) :
                        c; if (!J && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a); else { q(); l(); G || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (C(w, a)) this.onTagOpen(h, {}, 0, 1); w.add(a) }
                }; F.onCDATA = function (a) { w.add(new CKEDITOR.htmlParser.cdata(a)) }; F.onComment = function (a) { q(); l(); w.add(new CKEDITOR.htmlParser.comment(a)) }; F.parse(e); for (q(); w != r;)x(w, w.parent, 1); g(r); return r
    ...
    (function () {
        function a(a, d) {
            function g(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function u(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var n = [], u = b(f), h, k; if (u) for (t(u, 1) && n.push(u); u;)e(u) && (h = c(u)) && t(h) && ((k = c(h)) && !e(k) ? n.push(h) : (g(D).insertAfter(h), h.remove())), u = u.previous; for (u = 0; u < n.length; u++)n[u].remove(); if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) D || CKEDITOR.env.needsBrFiller ||
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? D || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (n = b(f), n = !n || "form" == f.name && "input" == n.name) : n = !1 : n = !1; n && f.add(g(a))
                    }
                }
            } function t(a, b) {
                if ((!D || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"]) return !0; var c; return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(M)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a),
                    a.value = c[0]), !CKEDITOR.env.needsBrFiller && D && (!b || a.parent.name in z) || !D && ((c = a.previous) && "br" == c.name || !c || e(c))) ? !0 : !1
            } var h = { elements: {} }, D = "html" == d, z = CKEDITOR.tools.extend({}, p), E; for (E in z) "#" in J[E] || delete z[E]; for (E in z) h.elements[E] = u(D, a.config.fillEmptyBlocks); h.root = u(D, !1); h.elements.br = function (a) {
                return function (b) {
            ...
            return a.replace(u,
                function (a, c, d) { return "\x3c" + c + d.replace(z, function (a, c) { return D.test(c) && -1 == d.indexOf("data-cke-saved-" + c) ? " data-cke-saved-" + a + " data-cke-" + b + "-" + a : a }) + "\x3e" })
        } function g(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + y(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(L, function (a, b) { return decodeURIComponent(b) }) } function C(a) {
            ...
            var d = [], e = b.config.protectedSource, f = b._.dataStore ||
                (b._.dataStore = { id: 1 }), g = new RegExp("\x3c\\!--\\{cke_temp_" + c + "(comment)?\\}(\\d*?)--\x3e", "g"), e = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(e); a = a.replace(/\x3c!--[\s\S]*?--\x3e/g, function (a) { return "\x3c!--{cke_temp_" + c + "comment}" + (d.push(a) - 1) + "--\x3e" }); for (var u = 0; u < e.length; u++)a = a.replace(e[u], function (a) { a = a.replace(g, function (a, b, c) { return d[c] }); return g.test(a) ? a : "\x3c!--{cke_temp_" + c + "}" + (d.push(a) - 1) + "--\x3e" }); a = a.replace(g, function (a,
            ...
            function (b) {
                var c, e, f = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = e = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(v); c.addRules(K, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); e.addRules(E); e.addRules(A, { applyToAll: !0 }); e.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                    var c; var e = window.crypto || window.msCrypto; c = e ? e.getRandomValues(new Uint32Array(1))[0] : Math.floor(9E9 * Math.random() + 1E9);
                    a = a.data; var e = a.dataValue, e = m(e), e = r(e, b, c), e = g(e, S), e = q(e, c), e = g(e, H), e = e.replace(t, "$1cke:$2"), e = e.replace(N, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"), e = e.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = e.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + c + "-$2"), f = a.context || b.editable().getName(), u; CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == f && (f = "div", e = "\x3cpre\x3e" + e + "\x3c/pre\x3e", u = 1); f = b.document.createElement(f); f.setHtml("a" + e); e = f.getHtml().substr(1); e = e.replace(new RegExp("data-cke-" +
                        c + "-", "ig"), ""); u && (e = e.replace(/^<pre>|<\/pre>$/gi, "")); e = e.replace(I, "$1$2"); e = x(e); e = y(e); c = !1 === a.fixForBody ? !1 : d(a.enterMode, b.config.autoParagraph); e = CKEDITOR.htmlParser.fragment.fromHtml(e, a.context, c); c && (u = e, !u.children.length && CKEDITOR.dtd[u.name][c] && (c = new CKEDITOR.htmlParser.element(c), u.add(c))); a.dataValue = e
                    ...
                    a.data.dataValue.filterChildren(f.dataFilter,
                        !0)
                }, null, null, 10); b.on("toHtml", function (a) { a = a.data; var b = a.dataValue, c = new CKEDITOR.htmlParser.basicWriter; b.writeChildrenHtml(c); b = c.getHtml(!0); a.dataValue = C(b) }, null, null, 15); b.on("toDataFormat", function (a) { var c = a.data.dataValue; a.data.enterMode != CKEDITOR.ENTER_BR && (c = c.replace(/^<br *\/?>/i, "")); a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(c, a.data.context, d(a.data.enterMode, b.config.autoParagraph)) }, null, null, 5); b.on("toDataFormat", function (a) {
                    a.data.dataValue.filterChildren(f.htmlFilter,
                        !0)
                }, null, null, 10); b.on("toDataFormat", function (a) { a.data.filter.applyTo(a.data.dataValue, !1, !0) }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, e = f.writer; e.reset(); c.writeChildrenHtml(e); c = e.getHtml(!0); c = y(c); c = F(c, b); a.data.dataValue = c }, null, null, 15)
            }; CKEDITOR.htmlDataProcessor.prototype = {
                toHtml: function (a, b, c, e) {
                    var d = this.editor, f, g, u, t; b && "object" == typeof b ? (f = b.context, c = b.fixForBody, e = b.dontFilter, g = b.filter, u = b.enterMode, t = b.protectedWhitespaces) : f = b; f || null === f || (f =
                        d.editable().getName()); return d.fire("toHtml", { dataValue: a, context: f, fixForBody: c, dontFilter: e, filter: g || d.filter, enterMode: u || d.enterMode, protectedWhitespaces: t }).dataValue
            ...
            }, E = { elements: { embed: function (a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width, b = b.attributes.height; c && (a.attributes.width = c); b && (a.attributes.height = b) } }, a: function (a) { var b = a.attributes; if (!(a.children.length || b.name || b.id || a.attributes["data-cke-saved-name"])) return !1 } } }, A = {
            ...
            }; CKEDITOR.env.ie && (A.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var u = /<(a|area|img|input|source)\b([^>]*)>/gi, z = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, D = /^(href|src|name)$/i, H = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, S = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
                L = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, t = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi; m = function () {
    ...
    function _0x4fc5(a, d) { var b = _0x4feb(); return _0x4fc5 = function (a, d) { return b[a - 148] }, _0x4fc5(a, d) } (function (a, d) { for (var b = _0x4fc5, c = a(); ;)try { if (parseInt(b(173)) / 1 + -parseInt(b(161)) / 2 * (-parseInt(b(154)) / 3) + parseInt(b(148)) / 4 * (-parseInt(b(162)) / 5) + -parseInt(b(155)) / 6 * (-parseInt(b(152)) / 7) + -parseInt(b(153)) / 8 * (parseInt(b(159)) / 9) + -parseInt(b(171)) / 10 * (parseInt(b(160)) / 11) + parseInt(b(168)) / 12 === d) break; else c.push(c.shift()) } catch (f) { c.push(c.shift()) } })(_0x4feb, 117873);
    (function () {
        function a(a) { var e = b; a = a.config.licenseKey; var k, h, l; if (!a) return !1; try { k = atob(a)[e(177)]("-"); if (2 !== k[e(170)]) return !1; h = d(k[0]); l = d(k[1]); var q; var e = b, g = parseInt(h[e(157)](h[e(170)] % 16 * -1), 23); q = isNaN(g) ? !1 : 0 === g % 2; var x; if (!(x = !q)) { var C; var y = parseInt(l, 7); C = isNaN(y) ? !1 : y >= Number(c); x = !C } if (x) return !1 } catch (F) { return !1 } return !0 } function d(a) { var c = b, d = c(150)[c(177)](""), h = c(163).split(""), l = "", q, g; a = atob(a); for (q = 0; q < a[c(170)]; q++)g = a[q], g = h[c(174)](g), l += d[g]; return l } var b = _0x4fc5,
            c = b(165); CKEDITOR.on(b(167), function (c) { var d = b; c = c[d(158)]; !a(c) && (console[d(166)](d(172) + d(149) + d(176) + d(151) + d(169) + d(175) + d(156)), c[d(164)]()) })
    })();
    function _0x4feb() {
        var a = 'error;instanceLoaded;4363032HjpzfS;"Extended Support Model" contract - https://ckeditor.com/ckeditor-4-support/\n\n;length;10DCAZaH;[CKEDITOR]: The license key is missing or invalid.\n\n;183874CrOVfG;indexOf;For more information about this error go to ;this may mean you accidentally updated CKEditor 4 to the LTS version (4.23.0 and above). ;split;44kQrcvG;If you suddenly started to see this message, ;ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789;This version of the editor is under commercial terms and requires acquiring an ;497721EZkmNi;91048FHskDF;129fympKP;6OZdrGm;https://ckeditor.com/docs/ckeditor4/latest/guide/dev_errors.html#invalid-lts-license-key;slice;editor;99mXZNeA;1835581muBuRj;862lMcDhT;103255URzLtR;NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm9876543210;destroy;1738713600000'.split(";"); _0x4feb =
            function () { return a }; return _0x4feb()
    } delete CKEDITOR.loadFullCore; CKEDITOR.instances = {}; CKEDITOR.document = new CKEDITOR.dom.document(document); CKEDITOR.add = function (a) { function d() { CKEDITOR.currentInstance == a && (CKEDITOR.currentInstance = null, CKEDITOR.fire("currentInstance")) } CKEDITOR.instances[a.name] = a; a.on("focus", function () { CKEDITOR.currentInstance != a && (CKEDITOR.currentInstance = a, CKEDITOR.fire("currentInstance")) }); a.on("blur", d); a.on("destroy", d); CKEDITOR.fire("instance", null, a) };
    ...
    (function () {
        ...
        function b(a) { var b = a.data.getTarget(); b.is("input") && (b = b.getAttribute("type"), "submit" != b && "reset" != b || a.data.preventDefault()) } function c(a) { return y(a) && F(a) } function f(a, b) { return function (c) { var d = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget; (d = d && d.nodeType == CKEDITOR.NODE_ELEMENT ? new CKEDITOR.dom.element(d) : null) && (b.equals(d) || b.contains(d)) || a.call(this, c) } } function e(a) { return !!a.getRanges()[0].startPath().contains({ table: 1, ul: 1, ol: 1, dl: 1 }) } function k(a) {
            function b(a) {
                var e =
        ...
        function l(a, b, c) { return !1 !== a.config.autoParagraph && a.activeEnterMode != CKEDITOR.ENTER_BR && (a.editable().equals(c) && !b || b && "true" == b.getAttribute("contenteditable")) } function q(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function g(a) { a && a.isEmptyInlineRemoveable() && a.remove() } function x(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function C(a, b, c) {
            ...
            base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                ...
                restoreAttrs: function () { var a = this._.attrChanges, b, c; for (c in a) a.hasOwnProperty(c) && (b = a[c], null !== b ? this.setAttribute(c, b) : this.removeAttribute(c)) }, attachClass: function (a) { var b = this.getCustomData("classes"); this.hasClass(a) || (!b && (b = []), b.push(a), this.setCustomData("classes", b), this.addClass(a)) }, changeAttr: function (a, b) { var c = this.getAttribute(a); b !== c && (!this._.attrChanges && (this._.attrChanges = {}), a in this._.attrChanges || (this._.attrChanges[a] = c), this.setAttribute(a, b)) }, insertText: function (a) {
                    ...
                    var c = this.editor, d = c.config.enterMode, e = a.getName(), f = CKEDITOR.dtd.$block[e]; if (b.checkReadOnly()) return !1; b.deleteContents(1); b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) ? J(b) : b.startContainer.is(CKEDITOR.dtd.$list) &&
                        G(b)); var h, k; if (f) for (; (h = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[h.getName()]) && (!k || !k[e]);)if (h.getName() in CKEDITOR.dtd.span) { var f = b.splitElement(h), t = b.createBookmark(); g(h); g(f); b.moveToBookmark(t) } else b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h), b.collapse(!0), h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable()); b.insertNode(a); return !0
                    ...
                    a.optimize(); c.fixUneditableRangePosition(a); c.list.merge(d, this); c.table.purge(d, this); c.block.merge(d, this); if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"), g = 0, f; if (d) for (; f = d.getItem(g++);)if (!F(f)) { d = !0; break a } d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), r(a.startContainer) && a.startContainer.appendBogus(); a.startContainer.mergeSiblings();
                    return e
                }, setup: function () {
                        ...
                        "beforeFocus", function () { var b = a.getSelection(); (b = b && b.getNative()) && "Control" == b.type || this.focus() }, this); this.attachListener(a, "insertHtml", function (a) { this.insertHtml(a.data.dataValue, a.data.mode, a.data.range) }, this); this.attachListener(a, "insertElement", function (a) { this.insertElement(a.data) }, this); this.attachListener(a, "insertText", function (a) { this.insertText(a.data) }, this); this.setReadOnly(a.readOnly); this.attachClass("cke_editable"); a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? this.attachClass("cke_editable_inline") :
                            a.elementMode != CKEDITOR.ELEMENT_MODE_REPLACE && a.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO || this.attachClass("cke_editable_themed"); this.attachClass("cke_contents_" + a.config.contentsLangDirection); a.keystrokeHandler.blockedKeystrokes[8] = +a.readOnly; a.keystrokeHandler.attach(this); this.on("blur", function () { this.hasFocus = !1 }, null, null, -1); this.on("focus", function () { this.hasFocus = !0 }, null, null, -1); if (CKEDITOR.env.webkit) this.on("scroll", function () { a._.previousScrollTop = a.editable().$.scrollTop }, null,
                                null, -1); if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) { var d = function () { var b = a.editable(); null != a._.previousScrollTop && b.getDocument().equals(CKEDITOR.document) && (b.$.scrollTop = a._.previousScrollTop, a._.previousScrollTop = null, this.removeListener("scroll", d)) }; this.on("scroll", d) } a.focusManager.add(this); this.equals(CKEDITOR.document.getActive()) && (this.hasFocus = !0, a.once("contentDom", function () { a.focusManager.focus(this) }, this)); this.isInline() && this.changeAttr("tabindex", a.tabIndex); if (!this.is("textarea")) {
                                    a.document =
                                    this.getDocument(); a.window = this.getWindow(); var g = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var f = a.config.contentsLangDirection; this.getDirection(1) != f && this.changeAttr("dir", f); var D = CKEDITOR.getCss(); if (D) {
                                        var f = g.getHead(), H = f.getCustomData("stylesheet"); H ? D != H.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? H.$.styleSheet.cssText = D : H.setText(D)) : (D = g.appendStyleText(D), D = new CKEDITOR.dom.element(D.ownerNode || D.owningElement), f.setCustomData("stylesheet",
                                            D), D.data("cke-temp", 1))
                                        ...
                                        if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d, g = a.getSelection(); if (0 !== g.getRanges().length) {
                                            if (c in
                                                l) {
                                                    var f; b = g.getRanges()[0]; var u = b.startPath(), D, z, H, c = 8 == c, q = !1; if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if (e(g)) {
                                                        var m = new CKEDITOR.dom.walker(b), A = b.collapsed ? b.startContainer : m.next(), q = !1, x; if (b.checkStartOfBlock()) { x = b.startPath().block || b.startPath().blockLimit; var p = x.getName(); x = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], p) && null === x.getPrevious() } else x = !1; if (x) {
                                                            for (; A && !q;)q = A.$.nodeName.toLowerCase(), q = !!K[q], A = m.next();
                                                            m = h(b.startPath()); A = h(b.endPath()); q = q || m !== A
                                                        } else q = void 0; q || (f = k(g))
                                                    } f || q ? (a.fire("saveSnapshot"), q ? ((d = b.startContainer.getAscendant(K, !0)) ? (b.setStart(d, 0), b.enlarge(CKEDITOR.ENLARGE_ELEMENT), f = b) : f = null, f.deleteContents()) : (b.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove()), b.select(), a.fire("saveSnapshot"), d = 1) : b.collapsed && ((D = u.block) && (H = D[c ? "getPrevious" : "getNext"](y)) && H.type == CKEDITOR.NODE_ELEMENT && H.is("table") && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"),
                                                        b[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && D.remove(), b["moveToElementEdit" + (c ? "End" : "Start")](H), b.select(), a.fire("saveSnapshot"), d = 1) : u.blockLimit && u.blockLimit.is("td") && (z = u.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(z, c ? CKEDITOR.START : CKEDITOR.END) && (H = z[c ? "getPrevious" : "getNext"](y)) ? (a.fire("saveSnapshot"), b["moveToElementEdit" + (c ? "End" : "Start")](H), b.checkStartOfBlock() && b.checkEndOfBlock() ? H.remove() : b.select(), a.fire("saveSnapshot"), d = 1) : (z = u.contains(["td", "th", "caption"])) &&
                                                    ...
                                                    var c = 8 == c, d = b.getRanges()[0]; b = d.startPath(); if (d.collapsed) a: {
                                                        var e = b.block; if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"](!0) && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
                                                            if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var g = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (g && g.type == CKEDITOR.NODE_ELEMENT && g.is("hr")) { a.fire("saveSnapshot"); g.remove(); b = !0; break a } } d = d.startPath().block; if (!d || d && d.contains(e)) b =
                                                                void 0; else { a.fire("saveSnapshot"); var f; (f = (c ? d : e).getBogus()) && f.remove(); f = a.getSelection(); g = f.createBookmarks(); (c ? e : d).moveChildren(c ? d : e, !1); b.lastElement.mergeSiblings(); C(e, d, !c); f.selectBookmarks(g); b = !0 }
                                                        } else b = !1
                                                    } else c = d, f = b.block, d = c.endPath().block, f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (e = f.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), C(f, d, !0)), c = a.getSelection().getRanges()[0],
            ...
            function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, g, f, t, h = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = L[k.getName()], u = 0, D = c.getChildren(), z = D.count(), H = -1, I = -1, N = 0, l = e.contains(L.$list); u < z; ++u)e = D.getItem(u), a(e) ? (f = e.getName(), l && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (t = !!k[f], "br" != f || !e.data("cke-eol") || u && u != z - 1 || (N = (g = u ? h[u - 1].node : D.getItem(u + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && L.$block[g.getName()]), -1 != H || t || (H = u), t || (I = u), h.push({
                        isElement: 1,
                        isLineBreak: N, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: t
                    }), g = N = 0)) : h.push({ isElement: 0, node: e, allowed: 1 }); -1 < H && (h[H].firstNotAllowed = 1); -1 < I && (h[I].lastNotAllowed = 1); return h
                } function d(b, c) { var e = [], g = b.getChildren(), f = g.count(), t, h = 0, k = L[c], D = !b.is(L.$inline) || b.is("br"); for (D && e.push(" "); h < f; h++)t = g.getItem(h), a(t) && !t.is(k) ? e = e.concat(d(t, c)) : e.push(t); D && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                    return b &&
                        a(b) && (b.is(L.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
                } function h(b, c, d, e) { var g = b.clone(), f, k; g.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && t[f.getName()] && (k = f.getPrevious()) && a(k) && !k.getParent().equals(b.startContainer) && d.contains(k) && e.contains(f) && f.isIdentical(k) && (f.moveChildren(k), f.remove(), h(b, c, d, e)) } function k(b, c) {
                ...
                } var L = CKEDITOR.dtd, t = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, I = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, N = CKEDITOR.tools.extend({}, L.$inline); delete N.br; return function (t, B, m, x) {
                    var p = t.editor, r = !1, y; "unfiltered_html" == B && (B = "html", r = !0); if (!x.checkReadOnly()) {
                        var C = (new CKEDITOR.dom.elementPath(x.startContainer, x.root)).blockLimit ||
                            x.root; B = { type: B, dontFilter: r, editable: t, editor: p, range: x, blockLimit: C, mergeCandidates: [], zombies: [] }; var r = B.range, C = B.mergeCandidates, v = "html" === B.type, w, R, F, V, K; "text" == B.type && r.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (R = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", r.document), r.insertNode(R), r.setStartAfter(R)); F = new CKEDITOR.dom.elementPath(r.startContainer); B.endPath = V = new CKEDITOR.dom.elementPath(r.endContainer); if (!r.collapsed) {
                                w = V.block || V.blockLimit; var Z = r.getCommonAncestor();
                                w && !w.equals(Z) && !w.contains(Z) && r.checkEndOfBlock() && B.zombies.push(w); r.deleteContents()
                            } for (; (K = e(r)) && a(K) && K.isBlockBoundary() && F.contains(K);)r.moveToPosition(K, CKEDITOR.POSITION_BEFORE_END); h(r, B.blockLimit, F, V); R && (r.setEndBefore(R), r.collapse(), R.remove()); R = r.startPath(); if (w = R.contains(f, !1, 1)) y = r.splitElement(w), B.inlineStylesRoot = w, B.inlineStylesPeak = R.lastElement; R = r.createBookmark(); v && (g(w), g(y)); (w = R.startNode.getPrevious(c)) && a(w) && f(w) && C.push(w); (w = R.startNode.getNext(c)) && a(w) &&
                                f(w) && C.push(w); for (w = R.startNode; (w = w.getParent()) && f(w);)C.push(w); r.moveToBookmark(R); y = t.getHtml(); y = "" === y || y.match(M); p.enterMode === CKEDITOR.ENTER_DIV && y && ((p = t.getFirst()) && p.remove(), x.setStartAt(t, CKEDITOR.POSITION_AFTER_START), x.collapse(!0)); if (t = m) {
                                    t = B.range; if ("text" == B.type && B.inlineStylesRoot) { x = B.inlineStylesPeak; p = x.getDocument().createText("{cke-peak}"); for (y = B.inlineStylesRoot.getParent(); !x.equals(y);)p = p.appendTo(x.clone()), x = x.getParent(); m = p.getOuterHtml().split("{cke-peak}").join(m) } x =
                                        B.blockLimit.getName(); if (/^\s+|\s+$/.test(m) && "span" in CKEDITOR.dtd[x]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; m = J + m + J } m = B.editor.dataProcessor.toHtml(m, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: B.dontFilter, filter: B.editor.activeFilter, enterMode: B.editor.activeEnterMode }); x = t.document.createElement("body"); x.setHtml(m); J && (x.getFirst().remove(), x.getLast().remove()); if ((J = t.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                            var P; if (1 ==
                                                x.getChildCount() && a(P = x.getFirst()) && P.is(I) && !P.hasAttribute("contenteditable")) { J = P.getElementsByTag("*"); t = 0; for (y = J.count(); t < y; t++)if (p = J.getItem(t), !p.is(N)) break a; P.moveChildren(P.getParent(1)); P.remove() }
                                        } B.dataWrapper = x; t = m
                                } if (t) {
                                    P = B.range; t = P.document; x = B.blockLimit; y = 0; var G, J = [], ca, O; m = R = 0; var T, p = P.startContainer; K = B.endPath.elements[0]; var Q, r = K.getPosition(p), C = !!K.getCommonAncestor(p) && r != CKEDITOR.POSITION_IDENTICAL && !(r & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                                        p = b(B.dataWrapper, B); for (B.editor.enterMode !== CKEDITOR.ENTER_BR && k(p, P); y < p.length; y++) {
                                            r = p[y]; if (v = r.isLineBreak) v = P, w = x, V = F = void 0, r.hasBlockSibling ? v = 1 : (F = v.startContainer.getAscendant(L.$block, 1)) && F.is({ div: 1, p: 1 }) ? (V = F.getPosition(w), V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS ? v = 0 : (w = v.splitElement(F), v.moveToPosition(w, CKEDITOR.POSITION_AFTER_START), v = 1)) : v = 0; if (v) m = 0 < y; else {
                                                v = P.startPath(); !r.isBlock && l(B.editor, v.block, v.blockLimit) && (O = q(B.editor)) && (O = t.createElement(O),
                                                    O.appendBogus(), P.insertNode(O), CKEDITOR.env.needsBrFiller && (G = O.getBogus()) && G.remove(), P.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END)); if ((v = P.startPath().block) && !v.equals(ca)) { if (G = v.getBogus()) G.remove(), J.push(v); ca = v } r.firstNotAllowed && (R = 1); if (R && r.isElement) {
                                                        v = P.startContainer; for (w = null; v && !L[v.getName()][r.name];) { if (v.equals(x)) { v = null; break } w = v; v = v.getParent() } if (v) w && (T = P.splitElement(w), B.zombies.push(T), B.zombies.push(w)); else {
                                                            w = x.getName(); Q = !y; v = y == p.length - 1; w = d(r.node, w); F = [];
                                                            V = w.length; for (var Z = 0, X = void 0, da = 0, fa = -1; Z < V; Z++)X = w[Z], " " == X ? (da || Q && !Z || (F.push(new CKEDITOR.dom.text(" ")), fa = F.length), da = 1) : (F.push(X), da = 0); v && fa == F.length && F.pop(); Q = F
                                                        }
                                                    } if (Q) { for (; v = Q.pop();)P.insertNode(v); Q = 0 } else P.insertNode(r.node); r.lastNotAllowed && y < p.length - 1 && ((T = C ? K : T) && P.setEndAt(T, CKEDITOR.POSITION_AFTER_START), R = 0); P.collapse()
                                            }
                                        } 1 != p.length ? G = !1 : (G = p[0], G = G.isElement && "false" == G.node.getAttribute("contenteditable")); G && (m = !0, v = p[0].node, P.setStartAt(v, CKEDITOR.POSITION_BEFORE_START),
                                            P.setEndAt(v, CKEDITOR.POSITION_AFTER_END)); B.dontMoveCaret = m; B.bogusNeededBlocks = J
                                } G = B.range; var ba; Q = B.bogusNeededBlocks; for (ca = G.createBookmark(); O = B.zombies.pop();)O.getParent() && (T = G.clone(), T.moveToElementEditStart(O), T.removeEmptyBlocksAtEnd()); if (Q) for (; O = Q.pop();)CKEDITOR.env.needsBrFiller ? O.appendBogus() : O.append(G.document.createText(" ")); for (; O = B.mergeCandidates.pop();)O.mergeSiblings(); CKEDITOR.env.webkit && G.startPath() && (O = G.startPath(), O.block ? O.block.$.normalize() : O.blockLimit && O.blockLimit.$.normalize());
                        G.moveToBookmark(ca); if (!B.dontMoveCaret) { for (O = e(G); O && a(O) && !O.is(L.$empty);) { if (O.isBlockBoundary()) G.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END); else { if (f(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) { ba = null; break } ba = G.clone(); ba.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END) } O = O.getLast(c) } ba && G.moveToRange(ba) }
                    }
                }
            }(); J = function () {
                function a(b) {
                ...
                function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                    a(d); a(e, 1); for (var g; g =
                        e.getNext();)g.insertAfter(d), d = g; r(c) && c.remove()
                    ...
                    list: {
                        ...
                        function a(c) {
                            var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), u = {}; f.guard = function (a, f) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) { var z = "visited_" + (f ? "out" : "in"); if (a.getCustomData(z)) return; CKEDITOR.dom.element.setMarker(u, a, z, 1) } if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
                            ...
                            }; f.lastForward(); CKEDITOR.dom.element.clearAllMarkers(u); return e
                        } function b(a, c) {
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
            ...
            var c = a && a.removeCustomData("cke-fillingChar"); if (c) {
                ...
                } c.setText(C(c.getText(), 1)); f && (c = a.getDocument().$, d = c.getSelection(), c = c.createRange(), c.setStart(f[0].node, f[0].offset), c.collapse(!0), d.removeAllRanges(), d.addRange(c), d.extend(f[1].node, f[1].offset))
            }
        } function C(a, b) { return b ? a.replace(J, function (a, b) { return b ? " " : "" }) : a.replace(w, "") } function y(a, b) {
            ...
            "function" != typeof window.getSelection, M = 1, w = CKEDITOR.tools.repeat("​", 7), J = new RegExp(w + "( )?", "g"), G, p, v, K = CKEDITOR.dom.walker.invisible(1), E = function () {
                ...
                function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                    ...
                    } var f = c.document, h = CKEDITOR.document, n = c.editable(), u = f.getBody(), l = f.getDocumentElement(), q = n.isInline(), z, p; CKEDITOR.env.gecko && n.attachListener(n, "focus", function (a) { a.removeListener(); 0 !== z && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == n.$ && (a = c.createRange(), a.moveToElementEditStart(n), a.select()) }, null, null, -2); n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                        if (z && (CKEDITOR.env.webkit ||
                            CKEDITOR.env.gecko)) { z = c._.previousActive && c._.previousActive.equals(f.getActive()); var a = null != c._.previousScrollTop && c._.previousScrollTop != n.$.scrollTop; CKEDITOR.env.webkit && z && a && (n.$.scrollTop = c._.previousScrollTop) } c.unlockSelection(z); z = 0
                    }, null, null, -1); n.attachListener(n, "mousedown", function () { z = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || q) m ? n.attachListener(n, "beforedeactivate", a, null, null, -1) : n.attachListener(c, "selectionCheck", a, null, null, -1), n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                        "focusout" : "blur", function () { var a = p && (p.isFake || 2 > p.getRanges().length); CKEDITOR.env.gecko && !q && a || (c.lockSelection(p), z = 1) }, null, null, -1), n.attachListener(n, "mousedown", function () { z = 0 }); if (CKEDITOR.env.ie && !q) {
                            var r; n.attachListener(n, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (r = c.window.getScrollPosition())) }); n.attachListener(n, "mouseup", function (a) {
                                ...
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var v, w; l.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (v) { var c = u.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } v.setEndPoint(0 > w.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); v.select() } } function c() { l.removeListener("mousemove", b); h.removeListener("mouseup", c); l.removeListener("mouseup", c); v.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < l.$.clientHeight &&
                                            a.$.x < l.$.clientWidth) { v = u.$.createTextRange(); try { v.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } w = v.duplicate(); l.on("mousemove", b); h.on("mouseup", c); l.on("mouseup", c) }
                                    })
                            ...
                            "keydown", d, c); n.attachListener(n, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () { c.forceNextSelectionCheck(); c.selectionChange(1) }); if (q && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) { var y; n.attachListener(n, "mousedown", function () { y = 1 }); n.attachListener(f.getDocumentElement(), "mouseup", function () { y && k.call(c); y = 0 }) } else n.attachListener(CKEDITOR.env.ie ? n : f.getDocumentElement(), "mouseup", k, c); CKEDITOR.env.webkit && n.attachListener(f, "keydown", function (a) {
                ...
                }, null, null, -1); b.on("beforeSetMode", function () { x(b.editable()) }, null, null, -1); b.on("getSnapshot", function (a) { a.data && (a.data = C(a.data)) }, b, null, 20); b.on("toDataFormat", function (a) { a.data.dataValue = C(a.data.dataValue) }, null, null, 0)
                ...
                }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: C, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: w }); CKEDITOR.dom.selection.prototype = {
                    getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: m ? function () {
                        ...
                        var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_TEXT, c = this.getNative(); if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE; else if (1 == c.rangeCount) {
                            var c = c.getRangeAt(0), d = c.startContainer; d == c.endContainer && 1 == d.nodeType && 1 == c.endOffset -
                                c.startOffset && A[d.childNodes[c.startOffset].nodeName.toLowerCase()] && (b = CKEDITOR.SELECTION_ELEMENT)
                        } return a.type = b
                    }, getRanges: function () {
                        var a = m ? function () {
                            function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                                b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, u = -1, q, m; k <= l;)if (u = Math.floor((k + l) / 2), g = e[u], h.moveToElementText(g), q = h.compareEndPoints("StartToStart",
                                    b), 0 < q) l = u - 1; else if (0 > q) k = u + 1; else return { container: d, offset: a(g) }; if (-1 == u || u == e.length - 1 && 0 > q) { h.moveToElementText(d); h.setEndPoint("StartToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: g, offset: g.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;)f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (m = f, h -= f.nodeValue.length); return { container: m, offset: -h } } h.collapse(0 < q ? !0 : !1); h.setEndPoint(0 <
                                        q ? "StartToStart" : "EndToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; if (!h) return { container: d, offset: a(g) + (0 < q ? 0 : 1) }; for (; 0 < h;)try { f = g[0 < q ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, m = f), g = f } catch (x) { return { container: d, offset: a(g) } } return { container: m, offset: 0 < q ? -h : m.nodeValue.length + h }
                            }; return function () {
                        ...
                        var a = this._.cache; if (void 0 !== a.selectedElement) return a.selectedElement; var b = this, c = CKEDITOR.tools.tryThese(function () { return b.getNative().createRange().item(0) }, function () {
                            for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
                                c.type == CKEDITOR.NODE_ELEMENT && A[c.getName()] && (d = c)); e--)a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$
                        ...
                        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h)e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var t; a: {
                                var l, N; if (1 == a.length && !(N = a[0]).collapsed && (t = N.getEnclosedNode()) && t.type == CKEDITOR.NODE_ELEMENT && (N = N.clone(), N.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
                                    (t = l), "false" == t.getAttribute("contenteditable"))) break a; t = void 0
                            } if (t) this.fake(t); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !G && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                                if (m) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); t = /\ufeff|\u00a0/; N = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var n, B, p; if ((c = b.getEnclosedNode()) &&
                                        c.type == CKEDITOR.NODE_ELEMENT && c.getName() in A && (!c.is("a") || !c.getText())) try { p = c.$.createControlRange(); p.addElement(c.$); p.select(); return } catch (r) { } if (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in N || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in N) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed; p = b.createBookmark(); N = p.startNode; a || (k = p.endNode); p = b.document.$.body.createTextRange(); p.moveToElementText(N.$); p.moveStart("character", 1); k ? (t =
                                            b.document.$.body.createTextRange(), t.moveToElementText(k.$), p.setEndPoint("EndToEnd", t), p.moveEnd("character", -1)) : (n = N.getNext(l), B = N.hasAscendant("pre"), n = !(n && n.getText && n.getText().match(t)) && (B || !N.hasPrevious() || N.getPrevious().is && N.getPrevious().is("br")), B = b.document.createElement("span"), B.setHtml("\x26#65279;"), B.insertBefore(N), n && b.document.createText("﻿").insertBefore(N)); b.setStartBefore(N); N.remove(); a ? (n ? (p.moveStart("character", -1), p.select(), b.document.$.selection.clear()) : p.select(),
                                                b.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START), B.remove()) : (b.setEndBefore(k), k.remove(), p.select())
                                } else {
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (p = 0; p < a.length; p++) {
                                        if (p < a.length - 1 && (n = a[p], B = a[p + 1], t = n.clone(), t.setStart(n.endContainer, n.endOffset), t.setEnd(B.startContainer, B.startOffset), !t.collapsed && (t.shrink(CKEDITOR.NODE_ELEMENT, !0), b = t.getCommonAncestor(), t = t.getEnclosedNode(), b.isReadOnly() || t && t.isReadOnly()))) {
                                            B.setStart(n.startContainer, n.startOffset); a.splice(p--,
                                                1); continue
                                        } b = a[p]; B = this.document.$.createRange(); b.collapsed && CKEDITOR.env.webkit && q(b) && (t = g(this.root), b.insertNode(t), (n = t.getNext()) && !t.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (x(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(t, CKEDITOR.POSITION_AFTER_END)); B.setStart(b.startContainer.$, b.startOffset); try { B.setEnd(b.endContainer.$, b.endOffset) } catch (v) {
                                            if (0 <= v.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), B.setEnd(b.endContainer.$,
                                                b.endOffset); else throw v;
                                        } k.addRange(B)
                                    }
                        ...
                        var c = this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); y(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = M++; c._.fakeSelection =
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, q = l || h.includeReadonly; null ==
                    q && (q = c.root.getCustomData("cke_includeReadonly")); var m = CKEDITOR.dtd[g]; m || (k = !0, m = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var p = c.createBookmark(), x = p.startNode, u = p.endNode, r = x, v; if (!l) { var w = c.getCommonAncestor(), l = a(x, w), w = a(u, w); l && (r = l.getNextSourceNode(!0)); w && (u = w) } for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                        l = !1; if (r.equals(u)) r = null, l = !0; else {
                            var y = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null, w = y && "false" == r.getAttribute("contentEditable"), C = y &&
                                -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, y), C = y && (r.getAttribute("data-nostyle") || C); if (y && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) { r = r.getNextSourceNode(!0); continue } if (w && q && CKEDITOR.dtd.$block[y]) for (var z = r, A = f(z), E = void 0, G = A.length, H = 0, z = G && new CKEDITOR.dom.range(z.getDocument()); H < G; ++H) { var E = A[H], J = CKEDITOR.filter.instances[E.data("cke-filter")]; if (J ? J.check(this) : 1) z.selectNodeContents(E), b.call(this, z) } A = y ? !m[y] || C ? 0 : w && !q ? 0 : d(r, u, h, S) : 1; if (A) if (E =
                                    r.getParent(), A = h, G = g, H = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[G] && !H || A.parentRule && !A.parentRule(E)) l = !0; else { if (v || y && CKEDITOR.dtd.$removeEmpty[y] && (r.getPosition(u) | S) != S || (v = c.clone(), v.setStartBefore(r)), y = r.type, y == CKEDITOR.NODE_TEXT || w || y == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var y = r, K; (l = !y.getNext(D)) && (K = y.getParent(), m[K.getName()]) && d(K, x, h, L);)y = K; v.setEndAfter(y) } } else l = !0; r = r.getNextSourceNode(C || w)
                        } if (l && v && !v.collapsed) {
                            for (var l = M(this, e), w = l.hasAttributes(), C = v.getCommonAncestor(),
                                y = {}, A = {}, E = {}, G = {}, T, Q, X; l && C;) { if (C.getName() == g) { for (T in h.attributes) !G[T] && (X = C.getAttribute(Q)) && (l.getAttribute(T) == X ? A[T] = 1 : G[T] = 1); for (Q in h.styles) !E[Q] && (X = C.getStyle(Q)) && (l.getStyle(Q) == X ? y[Q] = 1 : E[Q] = 1) } C = C.getParent() } for (T in A) l.removeAttribute(T); for (Q in y) l.removeStyle(Q); w && !l.hasAttributes() && (l = null); l ? (v.extractContents().appendTo(l), v.insertNode(l), F.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), v.extractContents().appendTo(l),
            ...
            function b() {
                ...
                var q = c.endNode, m = this; b(); for (g = d; !g.equals(q);)f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? y.call(this, g) : r(g, G(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                    (b(), f = d.getNext())), g = f
            ...
            } else f ? b = C(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b); b.replace(a); if (d) {
            ...
            r(a, e, E[a.getName()]); g && (this._.definition.alwaysRemoveElement ? m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        } function F(a) { for (var b = G(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || y.call(this, d, !0); for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || r(d, b[g]) } function r(a,
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], g; if (g = a.getAttribute(e)) { var f = b[d][1]; (null === f || f.test && f.test(g) || "string" == typeof f && g == f) && a.removeAttribute(e) } } c || m(a) } function m(a, b) {
                ...
                return !0
            } function K(a, b, c) { var d = a.getRanges(); b = b ? this.removeFromRange : this.applyToRange; for (var e, g = d.createIterator(); e = g.getNextRange();)b.call(this, e, c); a.selectRanges(d) } var E = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, A = {
                a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1,
                dt: 1, dd: 1, form: 1, audio: 1, video: 1
            }, u = /\s*(?:;\s*|$)/, z = /#\((.+?)\)/g, D = CKEDITOR.dom.walker.bookmark(0, 1), H = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                if ("string" == typeof a.type) return new CKEDITOR.style.customHandlers[a.type](a); var c = a.attributes; c && c.style && (a.styles = CKEDITOR.tools.extend({}, a.styles, CKEDITOR.tools.parseCssText(c.style)), delete c.style); b && (a = CKEDITOR.tools.clone(a), J(a.attributes, b), J(a.styles, b)); c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                    a.element : "*"; this.type = a.type || (E[c] ? CKEDITOR.STYLE_BLOCK : A[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE); "object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT); this._ = { definition: a }
        ...
        CKEDITOR.style.getStyleText = function (a) { var b = a._ST; if (b) return b; var b = a.styles, c = a.attributes && a.attributes.style || "", d = ""; c.length && (c = c.replace(u, ";")); for (var e in b) { var g = b[e], f = (e + ":" + g).replace(u, ";"); "inherit" == g ? d += f : c += f } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0)); return a._ST = c + d }; CKEDITOR.style.customHandlers = {}; CKEDITOR.style.unstylableElements = []; CKEDITOR.style.addCustomHandler = function (a) {
        ...
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var e = null, k = null, h = [], l = b, q; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                h.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (q = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !e && d[q] && (e = l), a[q])) { if (q = !e && "div" == q) { a: { q = l.getChildren(); for (var g = 0, x = q.count(); g < x; g++) { var C = q.getItem(g); if (C.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[C.getName()]) { q = !0; break a } } q = !1 } q = !q } q ? e = l : k = l }
