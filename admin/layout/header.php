                                ...
                                <div class="d-lg-flex align-items-start">
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            ...
                                            <h6 class="fw-bolder">Ecommerce - Admin Dashboard UiKit</h6>
                                            <p class="fs-12 fw-normal text-muted text-truncate-3-line">Get started Ecommerce with Ecommerce up and running. Ecommerce bootstrap template docs helps you to get started with simple html codes.</p>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all resources on Ecommerce &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="p-3 bg-soft-dark text-dark rounded d-lg-flex align-items-center justify-content-between">
                                                                        <div class="fs-13">
                                                                            ...
                                                                            <span>View all services on Ecommerce.</span>
                                                                        </div>
                                                                        <div class="mt-2 mt-lg-0">
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View all features on Ecommerce &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
