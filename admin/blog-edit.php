...
$id = $_GET['id'];
$row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM `blog` WHERE id='$id'"));
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" name="blog_title" id="blog_title" value="<?php echo $row['blog_title']; ?>" class="form-control mb-2" placeholder="Title" required>
                                    </div>
                                    <div class="col-lg-6 mb-4">
                                        <label for="" class="form-label mb-2 fs-6 mb-2">Blog Slug</label>
                                        <input type="text" name="blog_slug" id="blog_slug" value="<?php echo $row['blog_slug']; ?>" class="form-control" placeholder="Slug">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <input type="text" name="short_description" value="<?php echo $row['short_description']; ?>" class="form-control mb-2" placeholder="Short Description">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        ...
                                        <textarea type="text" name="long_description" id="editor" rows="8" class="form-control mb-2" placeholder="Long Description"><?php echo $row['long_description']; ?></textarea>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        <label for="" class="form-label fs-6 mb-2">Additional Information</label>
                                        <textarea type="text" name="additional_info" id="editor1" rows="8" class="form-control mb-2" placeholder="blog Additional Information"><?php echo $row['additional_info']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="date" name="publish_date" value="<?= date('Y-m-d', ($row['publish_date'])) ?>"  class="form-control mb-2" placeholder="MM/DD/YY"  >
                                    </div>
                                </div>
