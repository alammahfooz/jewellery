                ...
                <div class="col-lg-7 offset-lg-1">
                    <div class="accordion-main-area-wrapper-style-1">
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Etiam penatibus congue tincidunt et aliquam blandit condimentum sapien erat placerat, mi habitant tempus in per nisl parturient enim vel, dictum class auctor scelerisque molestie lobortis risus maecenas diam. Posuere duis nostra laoreet suscipit vitae in sem id iaculis vivamus,
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsTen" aria-expanded="false" aria-controls="collapsTen">
                                        What is the symbol for gold on the periodic table?
                                    </button>
                                </h2>
                                <div id="collapsTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Etiam penatibus congue tincidunt et aliquam blandit condimentum sapien erat placerat, mi habitant tempus in per nisl parturient enim vel, dictum class auctor scelerisque molestie lobortis risus maecenas diam. Posuere duis nostra laoreet suscipit vitae in sem id iaculis vivamus,
                                    </div>
                                </div>
