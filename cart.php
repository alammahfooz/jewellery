...
if (isset($_GET['clear_cart'])) {
    ...
    unset($_SESSION['cart']);   // remove full cart
    $_SESSION['cart'] = [];     // reset empty array
...
header("Location: cart.php"); // important
exit();
}
                ...
                <div class="col-xl-9 col-lg-12 col-md-12 col-12 order-2 order-xl-1 order-lg-2 order-md-2 order-sm-2">
                    ...
                    <div class="rts-cart-list-area">
                        ...
                        <div class="single-cart-area-list main  item-parent">
                          ...
                          <?php $i++; } }else echo "<p class='text-center fs-2 p-4 text-danger'>cart is empty</p>" ?>
